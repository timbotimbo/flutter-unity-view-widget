...
```
https://github.com/timbotimbo/flutter-unity-view-widget.git?path=example/unity/DemoApp/Assets/FlutterUnityIntegration#UPM
```
...
- `#flutter_unity_widget_2-6000` The main branch for Unity 6 support. Includes all demo assets (read-only) in the package.
